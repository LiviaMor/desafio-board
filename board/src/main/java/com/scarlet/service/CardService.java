package com.scarlet.service;

import com.scarlet.dto.BoardColumnInfoDTO;
import com.scarlet.exception.CardBlockedException;
import com.scarlet.exception.CardFinishedException;
import com.scarlet.exception.EntityNotFoundException;
import com.scarlet.persistence.dao.BlockDAO;
import com.scarlet.persistence.dao.CardDAO;
import com.scarlet.persistence.entity.BoardColumnKindEnum;
import com.scarlet.persistence.entity.CardEntity;
...
import static com.scarlet.persistence.entity.BoardColumnKindEnum.CANCEL;
    ...
    public void block(final Long id, final String reason, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            ...
            var currentColumn = boardColumnsInfo.stream()
                    ...
                    .findFirst()
                    .orElseThrow();
            if (currentColumn.kind().equals(BoardColumnKindEnum.FINAL) || currentColumn.kind().equals(CANCEL)){
